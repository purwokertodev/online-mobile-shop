...
<div class="panel panel-primary">
    ...
    <div class="panel-body">
        <form action="index.php?admin=tambah_panduan_finish" method="post" class="form-horizontal">
            <div class="form-group">
                <label class="col-sm-2 control-label">Isi Panduan :</label>
                <div class="col-sm-4">
                    <textarea name="isi_panduan" class="form-control" cols="10" rows="7" required="true"></textarea>
                </div>
            </div>
            <div class="form-group">
                <div class="col-sm-4">
