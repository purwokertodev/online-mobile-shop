...
<div class="panel panel-primary">
    <div class="panel-heading">
        Tambah Data Pabrikan
    </div>
    <div class="panel-body">
        <form action="index.php?admin=tambah_pabrikan_finish" method="post" class="form-horizontal">
            <div class="form-group">
                <label class="col-sm-2 control-label">Nama Pabrikan :</label>
                <div class="col-sm-4">
                    <input type="text" name="nama_pabrikan" class="form-control" required="true" placeholder="Nama Pabrikan"/>
                </div>
            </div>
            <div class="form-group">
