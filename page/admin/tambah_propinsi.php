...
<div class="panel panel-primary">
    ...
    <div class="panel-body">
        <form action="index.php?admin=tambah_propinsi_finish" method="post" class="form-horizontal">
            <div class="form-group">
                <label class="col-sm-2 control-label">Nama Propinsi :</label>
                <div class="col-sm-4">
                    <input type="text" name="nama_propinsi" class="form-control" required="true" placeholder="Nama Propinsi"/>
                </div>
            </div>
            <div class="form-group">
                <div class="col-sm-4">
